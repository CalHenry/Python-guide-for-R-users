...
??? note "La philosophie du terminal"
    ...
    Rien ne t'oblige à adhérer à cette philosophie heureusement, mais tu sais maintenant pourquoi il est tant utilisé dès qu'on touche à l'informatique et pourquoi une bonne partie de ce que tu fais dans ton ordinateur peut être faite plus rapidement depuis le terminal.
...
- Rechercher un mot ou une séquence dans un dossier sans savoir où il se trouve
- ...
...
Mais si tu dois te connecter à une machine dans un datacenter, le seul moyen d'interagir avec et de se connecter à son terminal (et de la contrôler avec son terminal).

Savoir se débrouiller dans le terminal même qu'un peu est donc toujours utile, et facilitera tes progrès en informatique.

## Commades les plus importantes

- Chaque commande à plusieurs options et/ ou arguments que tu peux lui passer.
